...
// AllHistoricalResults import removed as it's now a separate page
// import { AllHistoricalResults } from '@/components/toto/AllHistoricalResults';


// TotoView type and currentView state removed
...
export default function TotoForecasterPage() {
  ...
  // currentView state and handlers removed
  ...
  // View switching functions removed
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      <main className="flex-grow container mx-auto px-4 py-8 md:px-6 md:py-12">
        {/* Conditional rendering for currentView removed, always show Tabs */}
        ...
        {/* AllHistoricalResults component rendering removed */}
        {/* 
